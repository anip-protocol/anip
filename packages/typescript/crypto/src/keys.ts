/**
 * Key management for ANIP v0.2.
 *
 * Uses the `jose` library for ES256 JWT signing/verification and JWS detached
 * signatures.  Manages two key pairs: one for delegation tokens, one for audit
 * entry signing.
 */
...
export class KeyManager {
  ...
  // --------------- public key / kid accessors ---------------

  getDelegationPublicKey(): CryptoKey {
