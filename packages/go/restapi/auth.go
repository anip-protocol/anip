...
// resolveRestAuth resolves auth from a bearer token string.
...
func resolveRestAuth(bearer string, svc *service.Service, capabilityName string) (*core.DelegationToken, error) {
