...
**What's next:**
- ANIP Studio Phase 2 — capability invocation, permissions inspection, streaming visualization, lineage tracing
- anip.dev — documentation hub, package ecosystem portal, Studio hosting
