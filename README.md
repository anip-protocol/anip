...
- [Agent contract drafter skill](skills/anip-contract-drafter.md) — machine-optimized guidance for drafting a local experimental ANIP service definition
