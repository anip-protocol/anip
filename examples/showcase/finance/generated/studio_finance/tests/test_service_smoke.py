...
from anip_finance_showcase.runtime_target import GENERATED_CAPABILITY_METADATA

SERVICE_MODULES = [
    {"service_id": "finance-ops-service", "module": "anip_finance_showcase.app", "capabilities": ["finance.query_portfolio", "finance.get_market_data", "finance.execute_trade", "finance.transfer_funds", "finance.generate_report"]},
]
