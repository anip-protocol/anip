...
from notion_governed_fronting_showcase.runtime_target import GENERATED_CAPABILITY_METADATA

SERVICE_MODULES = [
    {"service_id": "notion-governance-service", "module": "notion_governed_fronting_showcase.app", "capabilities": ["notion.workspace.search_context", "notion.database.query_context", "notion.page.create.prepare", "notion.page.update.prepare", "notion.comment.prepare"]},
]
