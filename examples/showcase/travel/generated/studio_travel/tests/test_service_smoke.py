...
from anip_travel_showcase.runtime_target import GENERATED_CAPABILITY_METADATA

SERVICE_MODULES = [
    {"service_id": "travel-booking-service", "module": "anip_travel_showcase.app", "capabilities": ["travel.search_flights", "travel.check_availability", "travel.book_flight", "travel.cancel_booking"]},
]
