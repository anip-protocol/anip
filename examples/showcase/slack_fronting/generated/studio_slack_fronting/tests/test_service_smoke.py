...
SERVICE_MODULES = [
    {"service_id": "slack-governance-service", "module": "slack_governed_fronting_showcase.app", "capabilities": ["slack.channel.read_context", "slack.thread.summarize", "slack.message.prepare", "slack.incident_update.prepare", "slack.announcement.request"]},
]
