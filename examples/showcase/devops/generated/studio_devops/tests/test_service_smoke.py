...
from anip_devops_showcase.runtime_target import GENERATED_CAPABILITY_METADATA

SERVICE_MODULES = [
    {"service_id": "devops-infra-service", "module": "anip_devops_showcase.app", "capabilities": ["devops.list_deployments", "devops.get_service_health", "devops.scale_replicas", "devops.update_config", "devops.rollback_deployment", "devops.delete_resource", "devops.destroy_environment"]},
]
