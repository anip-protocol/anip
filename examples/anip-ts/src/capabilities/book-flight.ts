...
const DECLARATION: CapabilityDeclaration = {
  ...
  inputs: [
    { name: "flight_number", type: "string", required: true, default: null, description: "Flight to book", semantic_type: null, entity_reference: false, allowed_values: null, catalog_ref: null, input_meanings: null, resolution: null },
    ...
    { name: "passengers", type: "integer", required: false, default: 1, description: "Number of passengers", semantic_type: null, entity_reference: false, allowed_values: null, catalog_ref: null, input_meanings: null, resolution: null },
    { name: "quote_id", type: "object", required: true, default: null, description: "Priced quote from search_flights", semantic_type: null, entity_reference: false, allowed_values: null, catalog_ref: null, input_meanings: null, resolution: null },
  ],
