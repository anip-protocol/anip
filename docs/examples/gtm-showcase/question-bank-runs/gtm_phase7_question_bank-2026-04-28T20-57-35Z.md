...
- Generated at: `2026-04-28T20-57-35Z`
...
- Actual planned capability: `gtm.prioritized_outreach_draft`
- Expected capability: `not asserted`
- Actual capability: `gtm.prioritized_outreach_draft`
...
- Actual outcome: `approval_required`
- Expected planned capability: `not asserted`
- Actual planned capability: `gtm.bottleneck_account_outreach_draft`
- Expected capability: `not asserted`
- Actual capability: `gtm.bottleneck_account_outreach_draft`
- Expected service: `not asserted`
- Actual service: `outreach`
- Loops: `{'planner_loops': 1, 'service_invoke_loops': 1, 'total_loops': 2}`
