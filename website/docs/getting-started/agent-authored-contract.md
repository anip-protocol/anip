...
- Example service definitions:
  - [`jira-fronting-showcase-0.2.0-service-definition.json`](https://github.com/anip-protocol/anip/blob/main/examples/showcase/jira_fronting/registry-packages/jira-fronting-showcase-0.2.0-service-definition.json)
