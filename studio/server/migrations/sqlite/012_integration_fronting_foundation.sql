...
ALTER TABLE projects
    ADD COLUMN integration_profile TEXT NOT NULL DEFAULT '{"kind":"none","systems":[]}';
...
CREATE TABLE workspace_connections (
    ...
    allowed_project_refs TEXT NOT NULL DEFAULT '[]',
...
CREATE TABLE integration_discovery_records (
    ...
    input_schema_summary TEXT NOT NULL DEFAULT '{}',
