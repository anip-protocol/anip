...
**Examples** — The `examples/` directory contains reference implementations (Python and TypeScript), `packages/go/examples/` contains the Go reference implementation, and `packages/java/anip-example-flights/` contains the Java reference implementation. We welcome implementations in any language that demonstrate ANIP concepts.
